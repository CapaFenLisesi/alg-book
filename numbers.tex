...
\subsubsection{Vinculum is a grouping symbol}
...
%=	&~ -38\\
%\end{aligned}\]
A very common mistake is to do the $12-5$ first, instead of the $5(10)$, but that would violate the order of operations!
\end{boxedex}
