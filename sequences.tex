...
\begin{boxedexplore}[Startup exploration: {S}ierpi\'nski's carpet]
...
\begin{boxedexplore}[Startup exploration: {K}och curve, square version]
...
The linear family, represented in this chapter by the idea of an arithmetic sequence, will become our focus starting in \cref{ch:equations}. The exponential family, represented in this chapter by the geomertic functions, will be our focus in \cref{ch:expofunc,,expoexpr}. Quadratic sequences and the quadratic family will be in the spotlight starting in chapter \cref{sec:quadeq}.
