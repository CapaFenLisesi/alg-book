...
\end{boxexplore}
\kverse{Bob and Yeardleigh play number guessing games as children.}
...
\\[\fracspace]
7 \left(\frac{1}{3}\right)\left(\frac{1}{3}\right)
&=& 7\left(\frac{1}{3}\right)^{2}
& length of one segment in stage 2
\\[\fracspace]
7 \left(\frac{1}{3}\right) \left(\frac{1}{3}\right) \left(\frac{1}{3}\right)
&=& 7\left(\frac{1}{3}\right)^{3}
