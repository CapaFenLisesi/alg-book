...
\begin{boxedexplore}[Communicating a pattern]
...
%\begin{boxedexplore}[Extended exploration: {S}ierpi\'nski's triangle]
...
\begin{boxedexplore}[{S}ierpi\'nski's carpet]
...
%\begin{boxedexplore}[Extended exploration: {K}och curve, triangular version]
...
\begin{boxedexplore}[{K}och curve, square version]
...
\begin{boxedexplore}[Tile pattern \#1]
...
\begin{boxedexplore}[Tile pattern \#2]
...
The linear family, represented in this chapter by the idea of an arithmetic sequence, will become our focus starting in \cref{ch:equations}. The exponential family, represented in this chapter by the geomertic sequences, will be our focus in \cref{ch:expofunc,,expoexpr}. Quadratic sequences and the quadratic family will be in the spotlight starting in chapter \cref{sec:quadeq}.
