...
\begin{boxedexplore}[Derivation \#1]
...
\begin{boxedexplore}[Derivation \#2]
Use expanded form to write each of the expressions below as a single base raised to a singe exponent.
...
\begin{boxedexplore}[Derivation \#3]
...
\begin{boxedexplore}[Derivation \#4]
...
\begin{boxedexplore}[Derivation \#5]
Use expanded form to write each of the expressions below as a single base raised to a singe exponent.
...
\begin{boxedexplore}[Derivation \#6]
Use expanded form to write each of the expressions below without parentheses.
...
\begin{boxedexplore}[Check this work!]
