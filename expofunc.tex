...
\begin{boxedexplore}[Startup exploration: Super seaweed]
...
\begin{boxedexplore}[Exploring {Z}eno's paradox]
...
%\begin{boxedexplore}[Extended exploration: Problem with turtles]
%\addtodoitem{LINK.}
%\end{boxedexplore}
\addtodoitem{Link to extended exploration: A problem w/ turtles}

\begin{boxedexplore}[Startup exploration: {C}antor set]
...
\begin{boxedexplore}[Startup exploration: {H}ermine's choice]
...
\begin{boxedexplore}[Exploring continuous compounding]
...
%\begin{boxedexplore}[Extended exploration: Problem with pintonium]
%LINK
%\end{boxedexplore}
...
\begin{boxedexplore}[Exploring the chessboard fable]
