...
\begin{boxeddefex}[Axiom: Closure Properties]
...
\begin{boxeddefex}[Axiom: Identity Properties]
...
\begin{boxeddefex}[Axiom: Inverse Properties]
...
\begin{boxeddefex}[Axiom: Commutative Properties]
...
\begin{boxeddefex}[Axiom: Associative Properties]
...
\begin{boxedexplore}[Expression Sort]
...
\begin{boxeddefex}[Properties of Equality: Addition and Subtraction]
...
\begin{boxeddefex}[Properties of Equality: Multiplication and Division]
...
Here again, note that since ``division'' is the same as ``multiplication by the reciprocal'', DPOE is really just MPOE in disguise. Note too that $c$ must not equal 0 when using DPOE, lest we be flummoxed upon division by zero.
...
If you don't like the side of the equation that the unknown is on, you can always rewrite the equation. For example if you have the equation $3=4+x$ and you really want the $x$ on the left-hand side, you can just rewrite the equation as $4+x=3$. Those are equivalent equations!
