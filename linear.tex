...
\begin{boxeddef}[Tangent: Order of the points]
...
\begin{boxedexplore}[One point, one slope]
...
\begin{boxedexplore}[Two become one]
...
\begin{boxedexplore}[Goats and chickens]
...
\begin{boxedexplore}[Graphical rectangle]
