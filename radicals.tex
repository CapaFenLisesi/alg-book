...
\begin{boxedexplore}[Startup exploration: Share the cheese]
...
\begin{boxedexplore}[Startup exploration: Half power]
...
\begin{boxedexplore}[Startup exploration: Building blocks]
...
\begin{boxeddef}[Product rule of radicals]
...
\begin{boxeddef}[Quotient rule of radicals]
...
\begin{boxedexplore}[Startup exploration: Squarea]
...
\begin{boxeddef}[{P}ythagorean theorem]
...
\begin{boxeddef}[{P}ythagorean triple]
...
\begin{boxedexplore}[Startup exploration: Grid distance]
...
\begin{boxeddef}[Distance formula]
...
\begin{boxeddef}[Midpoint formula]
...
\begin{tikzpicture}[scale=0.35]
	...
	\foreach \x in {9,12,15,18} \draw[fill=blue!50] (\x,1) -- (\x+2,1) -- (\x,5) -- cycle;
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.5]
	...
	\draw[thick] (2,6) -- (6,4);
	%% Box 2
	\draw[thick,fill=blue!50] (12,0) rectangle (18,6);
	\draw[thick,fill=white] (12,4) -- (14,0) -- (18,2) -- (16,6) -- cycle;
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.5]
	%% Box 2
	\draw[thick,fill=red!50] (12,0) rectangle (18,6);
	\draw[thick,fill=white] (12,4) -- (14,0) -- (18,2) -- (16,6) -- cycle;
\end{tikzpicture}
\end{center}
