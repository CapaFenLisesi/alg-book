...
\begin{tikzpicture}[scale=0.75]
	...
	\foreach \x in {1,6,11,16}
	{
		...
		\setcounter{primeHctr}{\x-1};
		\draw (\x+1.4,11.75) node{\arabic{primeHctr}};
		\stepcounter{primeHctr};
		\draw (\x+2.6,11.75) node{\arabic{primeHctr}};
		\stepcounter{primeHctr};
		\draw (\x+2,11.5) node{\arabic{primeHctr}};
		\stepcounter{primeHctr};
		\draw (\x+1.4,11.25) node{\arabic{primeHctr}};
		\stepcounter{primeHctr};
		\draw (\x+2.6,11.25) node{\arabic{primeHctr}};
%		\setcounter{hh}{\x-1};
