...
\chapquote{Ten less a thing, multiplied by itself, is a hundred plus a square less twenty things.}{Mu\d{h}ammad ibn M\={u}s\={a} al-Khw\={a}rizm\={\i}, Persian mathematician}
...
\begin{boxexplore}[Solutions and factors]
...
\begin{boxdef}[Zero product property]
...
\begin{boxexplore}[Factoring level 3]
...
\begin{boxwarn}[Not the sum of squares!]
...
\begin{boxdef}[Difference of squares]
\[a^2 - b^2= (a + b)(a - b).\]
\end{boxdef}
...
\begin{boxexplore}[Factoring level 4]
...
\begin{boxdef}[Perfect square trinomial]
...
\begin{boxexplore}[Factoring level 5]
...
\begin{boxdef}[The quadratic formula]
