...
%		xtick pos=left,
	...
	\addplot[thick, green!80!black] table [x=time, y=day1, col sep=comma] {water.csv};
	\addlegendentry{27 Feb 2010};
	\addplot[thick, blue] table [x=time, y=day2, col sep=comma] {water.csv};
